...
config.primary.coin.algorithms.mining = 'firopow';
...
config.primary.coin.mainnet.peerMagic = 'e3d9fef1';
config.primary.coin.mainnet.pubKeyHash = Buffer.from('52', 'hex').readUInt8(0);
config.primary.coin.mainnet.scriptHash = Buffer.from('07', 'hex').readUInt8(0);
config.primary.coin.mainnet.wif = Buffer.from('D2', 'hex').readUInt8(0);
config.primary.coin.mainnet.coin = 'firo';
...
config.primary.coin.testnet.peerMagic = 'cffcbeea';
config.primary.coin.testnet.pubKeyHash = Buffer.from('41', 'hex').readUInt8(0);
config.primary.coin.testnet.scriptHash = Buffer.from('B2', 'hex').readUInt8(0);
config.primary.coin.testnet.wif = Buffer.from('B9', 'hex').readUInt8(0);
config.primary.coin.testnet.coin = 'tfiro';
...
config.primary.payments.daemon.port = 8382;
