...
// Coin Configuration
config.primary.coin = {};
config.primary.coin.name = 'Neoxa';
config.primary.coin.symbol = 'NEOX';
...
config.primary.coin.mainnet.peerMagic = '47414d45';
...
config.primary.coin.mainnet.coin = 'neox';
...
config.primary.coin.testnet.scriptHash = Buffer.from('8E', 'hex').readUInt8(0);
config.primary.coin.testnet.wif = Buffer.from('72', 'hex').readUInt8(0);
config.primary.coin.testnet.coin = 'tneox';
