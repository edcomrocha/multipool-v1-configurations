...
// Avian Network Configuration File
...
const config = {};
config.enabled = true;
config.name = 'Pool-Aviancoin';
config.coins = ['Aviancoin'];
...
// Coin Configuration
config.primary.coin = {};
config.primary.coin.name = 'Aviancoin';
...
config.primary.coin.algorithms.mining = 'minotaurx'; // minotaurx/x16rt
config.primary.coin.algorithms.block = 'minotaurx'; // minotaurx/x16rt
...
config.primary.coin.mainnet.peerMagic = '52564c4d';
...
config.primary.coin.testnet.peerMagic = '52564c54';
